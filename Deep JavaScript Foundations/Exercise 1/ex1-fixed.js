...
function addWorkToProject(projectId, description, minutes) {
    ...
    if (projectEntryData.work.length > 1) {
        // sort work entrie in descending order of time spent
...
function updateProjectTotalTime(projectEntryData) {
    ...
    // console.log(projectEntryData.time);
}
...
// **************************
var projectTemplate = "<div class='project-entry'>" +
                            "<h3 class='project-description' rel='js-project-description'></h3>" + 
                            "<ul class='work-entries' rel='js-work-entries'></ul>" +
                            "<span class='work-time' rel='js-work-time'></span>" + 
                       "</div>";

var workEntryTemplate = "<li class='work-entry'>" + 
                            "<span class='work-time' rel='js-work-time'></span>" + 
                            "<span class='work-description' rel='js-work-description'></span>" + 
                        "</li>";
